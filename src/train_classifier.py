...
from src.models.char_classifier_module import HTRCharClassifier
...
def train(cfg: DictConfig) -> Tuple[Dict[str, float], Dict[str, Any]]:
    ...
    # Init data module
    log.info("Instantiating DataModule...")
    datamodule: LightningDataModule = CharDataModule(
    ...
    # model = HTRCharClassifier.load_from_checkpoint(ckpt_path) if ckpt_path is not None else model
    # Train the model
