...
from src.models.transformer_seg_mask_module import SegTransformerMaskLitModule
...
def train(cfg: DictConfig) -> Tuple[Dict[str, float], Dict[str, Any]]:
    ...
    model = SegTransformerMaskLitModule.load_from_checkpoint(ckpt_path) if ckpt_path is not None else model
    # Train the model
